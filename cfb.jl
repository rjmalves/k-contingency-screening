...
export edit_adjacencies!, verify_connectivity!, current_flow_betweenness!
export define_critical_nodes!
export s_edit_adjacencies!, s_verify_connectivity!, s_current_flow_betweenness!
export s_define_critical_nodes!
export cfb_exaus
export cfb_de
